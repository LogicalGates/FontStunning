 ...
 *
 * @author razasaeed135@gmail.com (Raza Saeed)
 */
public final class FontStunning {

    private FontStunning() {
    }
...
//        sRobotoMedium = getFontFromRes(R.raw.roboto_medium, context);
    ...
    /**
     * proxima_nova_bold font face
     *
     * @param context Context
     * @return Typeface object for proxima_nova_bold
     */
    public static Typeface proxima_nova_bold(Context context) {
        return FontSourceProcessor.process(R.raw.proxima_nova_bold, context);
    }

    /**
     * proxima_nova_light font face
     *
     * @param context Context
     * @return Typeface object for proxima_nova_light
     */
    public static Typeface proxima_nova_light(Context context) {
        return FontSourceProcessor.process(R.raw.proxima_nova_light, context);
    }

    /**
     * proxima_nova_reg font face
     *
     * @param context Context
     * @return Typeface object for proxima_nova_reg
     */
    public static Typeface proxima_nova_reg(Context context) {
        return FontSourceProcessor.process(R.raw.proxima_nova_reg, context);
    }
